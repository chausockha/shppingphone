...
<section class="feature_product_area section_gap">
				...
				@foreach($product as $value)	
					...
					<div class="f_p_item">
							<div class="f_p_img">
								...
								<div class="p_icon">
									<a class="{{!\Auth::id() ? 'js-show-login1' : 'js-favorite1' }}" href="{{route('favorite',$value->id)}}">
										<i class="lnr lnr-heart"></i>
									</a>
									<a class="add-cart1" href="{{route('add',$value->id)}}">
		...
		$(".add-cart1").click(function(event){
			event.preventDefault();
			let url = $(this).attr('href');
			//console.log(url);
			if (url) {
